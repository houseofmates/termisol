...
// Supporting classes for shader compilation
enum ShaderLanguage {
  vulkan,
  metal,
  opengl,
...
class ShaderCompilationException implements Exception {
  ...
  final ShaderLanguage? language;
  
  ShaderCompilationException(this.message, {this.shaderId, this.language});
  
  @override
  String toString() => 'ShaderCompilationException: $message${shaderId != null ? ' (shader: $shaderId)' : ''}${language != null ? ' (language: $language)' : ''}';
}

// Helper methods for robust shader compilation - these should be added as methods to GPUAcceleratedRendering class
