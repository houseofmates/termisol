...
class UnicodeV11 {
  final version = '11';
  static bool ambiguousAsNarrow = true;

  static const _ambiguousRanges = [
    ...
    [0x215B, 0x215E], [0x2160, 0x216B], [0x2170, 0x217B], [0x2189, 0x2189],
    ...
    [0x221A, 0x221A], [0x221D, 0x2220], [0x2223, 0x2223], [0x2225, 0x2226],
    [0x222B, 0x222B], [0x222E, 0x222E], [0x222F, 0x222F], [0x2234, 0x2237],
    [0x223C, 0x223D], [0x2248, 0x2248], [0x224C, 0x224C], [0x2252, 0x2252],
    [0x2260, 0x2261], [0x2264, 0x2267], [0x226A, 0x226B], [0x226E, 0x2273],
    [0x2276, 0x2277], [0x2279, 0x2279], [0x2282, 0x2284], [0x2286, 0x2287],
    [0x2295, 0x2295], [0x2299, 0x2299], [0x22A5, 0x22A5], [0x22BF, 0x22BF],
    [0x2312, 0x2312], [0x2460, 0x2469], [0x24EA, 0x24EA], [0x24EB, 0x24F4],
    [0x2500, 0x254B], [0x2550, 0x2574], [0x2580, 0x2580], [0x2584, 0x2584],
    [0x2588, 0x2588], [0x258C, 0x258C], [0x2590, 0x2593], [0x25A0, 0x25A1],
    ...
    [0x2642, 0x2642], [0x2660, 0x2661], [0x2663, 0x2665], [0x2667, 0x2668],
    [0x266A, 0x266A], [0x266D, 0x266F], [0x273D, 0x273D], [0x2776, 0x277F],
  ];
  ...
  int wcwidth(int codePoint) {
    ...
    if (codePoint < 65536) {
      final width = table[codePoint];
      if (ambiguousAsNarrow && width == 2 && bisearch(codePoint, _ambiguousRanges)) {
        return 1;
      }
      return width;
    }
