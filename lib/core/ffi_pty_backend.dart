...
class FfiPtyBackend implements TermisolPtyBackend {
  ...
  void resize(int cols, int rows) {
    ...
    try {
      ...
      if (kDebugMode) debugPrint('[ffi_pty] Resized to ${cols}x$rows');
    } catch (e) {
      if (kDebugMode) debugPrint('[ffi_pty] Resize error: $e');
    }
  }
  ...
  void _applyBackpressure() {
    ...
    if (kDebugMode) debugPrint('[ffi_pty] Applied backpressure');
  }
