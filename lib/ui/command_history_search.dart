      ...
      child: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: PkmTheme.primary.withOpacity(0.5)),
          ),
          child: Column(
            children: [
              // Search input
              Container(
                ...
                decoration: BoxDecoration(
                  border: Border(
                    bottom: BorderSide(color: PkmTheme.primary.withOpacity(0.3)),
                  ),
                ),
                child: KeyboardListener(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(
                        color: PkmTheme.text.withOpacity(0.5),
                        fontFamily: PkmTheme.fontUi,
                      ),
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return InkWell(
                            ...
                            child: Container(
                              ...
                              color: isSelected
                                  ? PkmTheme.primary.withOpacity(0.2)
                                  : Colors.transparent,
                              child: Row(
                                children: [
                                  Icon(
                                  ...
                                  if (isSelected)
                                    Text(
                                      'enter to select',
                                      style: TextStyle(
                                        color: PkmTheme.text.withOpacity(0.4),
                                        fontFamily: PkmTheme.fontUi,
                                        fontSize: 12,
                                      ),
                                    ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  border: Border(
                    top: BorderSide(color: PkmTheme.primary.withOpacity(0.2)),
                  ),
                ),
                child: Row(
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: PkmTheme.primary.withOpacity(0.15),
